...
public class ArrowSlider : MonoBehaviour
{
    ...
    // private ArrowView firstPrefabArrow;
    //
    //
    // private void Awake()
    // {
    ...
    //         firstPrefabArrow = arrowPrefabSequence[0].GetComponentInChildren<ArrowView>();
    // }
    //
    ...
    //     }
    //
    //     PlaySessionController.Instance.OnCommandTrigger(hasScored);
    // }
}