...
//     version 1.18.0
//     from Assets/Controls/SwipeControls.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Controls/SwipeControls.inputactions".
/// </summary>
/// <remarks>
...
public partial class @SwipeControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Touch"",
            ""id"": ""bdc9f81b-01cd-4a84-a7ae-cd55cda3d2ea"",
            ""actions"": [
                {
                    ""name"": ""PrimaryContact"",
                    ""type"": ""PassThrough"",
                    ""id"": ""e30d2662-81ef-4103-a61d-00f97816ab42"",
                ...
                },
                {
                    ...
                    ""type"": ""PassThrough"",
                    ""id"": ""8ea29985-17c3-4762-9220-5a514526267c"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4c6f4ec3-82fc-42f8-a062-7e0b1294ebe2"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8b8c1a5c-7b54-4024-87de-099fc1a79517"",
    ...
    ~@SwipeControls()
    {
        UnityEngine.Debug.Assert(!m_Touch.enabled, "This will cause a leak and performance issues, SwipeControls.Touch.Disable() has not been called.");
    }
